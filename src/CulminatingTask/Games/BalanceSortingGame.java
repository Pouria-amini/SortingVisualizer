...
public class BalanceSortingGame extends JPanel {
    ...
    public BalanceSortingGame() {
        ...
        aLabel.setIcon(new ImageIcon("src/CulminatingTask/Images/BottleA.png"));
        bLabel.setIcon(new ImageIcon("src/CulminatingTask/Images/BottleB.png"));
        cLabel.setIcon(new ImageIcon("src/CulminatingTask/Images/BottleC.png"));
        dLabel.setIcon(new ImageIcon("src/CulminatingTask/Images/BottleD.png"));
        eLabel.setIcon(new ImageIcon("src/CulminatingTask/Images/BottleE.png"));
        fLabel.setIcon(new ImageIcon("src/CulminatingTask/Images/BottleF.png"));
        gLabel.setIcon(new ImageIcon("src/CulminatingTask/Images/BottleG.png"));
        hLabel.setIcon(new ImageIcon("src/CulminatingTask/Images/BottleI.png"));
        iLabel.setIcon(new ImageIcon("src/CulminatingTask/Images/BottleJ.png"));
        jLabel.setIcon(new ImageIcon("src/CulminatingTask/Images/BottleH.png"));
    ...
    private void comboBoxesActionListener() {
        ...
        if (!selectedRight.equals("Select") && !selectedLeft.equals("Select")) {
            ...
            if (correctOrderOfWeights.get(selectedLeft) > correctOrderOfWeights.get(selectedRight)) {
                greaterOrSmallerSignLabel.setIcon(new ImageIcon("src/CulminatingTask/Images/LeftGreater.png"));
            ...
            // If the right one is larger, assign greater icon to the right and display the inequality on the history text field:
                ...
                greaterOrSmallerSignLabel.setIcon(new ImageIcon("src/CulminatingTask/Images/RightGreater.png"));
