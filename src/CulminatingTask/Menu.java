...
class Menu extends JPanel {
    ...
    private void initComponents(){
        ...
        sortvisPictureLabelInMenu.setIcon(new ImageIcon("src/CulminatingTask/Images/My_Post-14.png"));
        ...
        // Close button on top:
        closeButtonFromMenu.setIcon(new ImageIcon("src/CulminatingTask/Images/close-circle.png"));
        ...
        minButtonFromMenu.setIcon(new ImageIcon("src/CulminatingTask/Images/minus-circle.png"));
        ...
        // Info button on top:
        infoButtonFromMenu.setIcon(new ImageIcon("src/CulminatingTask/Images/information.png"));
