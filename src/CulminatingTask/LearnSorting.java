...
public class LearnSorting extends JPanel{
    ...
    public LearnSorting(){
        ...
        minButtonFromLS.setIcon(new ImageIcon("src/CulminatingTask/Images/minus-circle.png"));
        ...
        returnToMenuButtonFromLS.setIcon(new ImageIcon("src/CulminatingTask/Images/home-circle.png"));
        ...
        closeButtonFromLS.setIcon(new ImageIcon("src/CulminatingTask/Images/close-circle.png"));
        ...
        infoButtonFromLS.setIcon(new ImageIcon("src/CulminatingTask/Images/information.png"));
