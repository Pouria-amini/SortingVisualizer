...
public class Help extends JTabbedPane {
    ...
    private void initComponents() {
          ...
          setPanels(menuHelperPanel, returnToPreviousPanelFromHelper1,
                  menuPictureLabel,
                  "Menu",
                  "src/main/java/CulminatingTask/Images/MenuPicture.png");

          setPanels(learnSortingHelperPanel,
                  returnToPreviousPanelFromHelper2,
                  learnSortingPictureLabel,
                  "Learn Sorting",
                  "src/main/java/CulminatingTask/Images/SortingVisualizerPicture.png");

          setPanels(playTheGameHelperPanel,
                  returnToPreviousPanelFromHelper3,
                  playTheGamePictureLabel,
                  "Play the Game",
                  "src/main/java/CulminatingTask/Images/PlaySortingPictureBalanceGame.png");

          setPanels(profileHelperPanel,
                  returnToPreviousPanelFromHelper4,
                  profilePictureLabel,
                  "Profile",
                  "src/main/java/CulminatingTask/Images/ProfilePicture.png");
    ...
    private void setReturnButton(JButton returnButton) {
        ...
        returnButton.setIcon(new ImageIcon("src/main/java/CulminatingTask/Images/arrow-right-circle.png"));
