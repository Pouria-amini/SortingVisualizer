...
public class Profile extends JPanel {
    ...
    private void initComponents() {
        ...
        bubbleSortStatusLabel.setIcon(new ImageIcon("src/main/java/CulminatingTask/Images/lock-open-variant.png"));
        ...
        if (user.getScore() >= 15){ // If the user reaches 15 scores or more, the algorithms os unlocked
            selectionSortStatusLabel.setIcon(new ImageIcon("src/main/java/CulminatingTask/Images/lock-open-variant.png"));
            ...
            selectionSortStatusLabel.setIcon(new ImageIcon("src/main/java/CulminatingTask/Images/lock.png"));
        ...
        if (user.getScore() >= 5){ // If the user reaches 5 scores or more, the algorithms os unlocked
            insertionSortStatusLabel.setIcon(new ImageIcon("src/main/java/CulminatingTask/Images/lock-open-variant.png"));
            ...
            insertionSortStatusLabel.setIcon(new ImageIcon("src/main/java/CulminatingTask/Images/lock.png"));
        ...
        if (user.getScore() >= 25){ // If the user reaches 25 scores or more, the algorithms os unlocked
            shellSortStatusLabel.setIcon(new ImageIcon("src/main/java/CulminatingTask/Images/lock-open-variant.png"));
            shellSortStatusLabel.setText("Unlocked");
        } else { // If the user didn't reach 25 scores or more, show the required score for unlock
            shellSortStatusLabel.setIcon(new ImageIcon("src/main/java/CulminatingTask/Images/lock.png"));
        ...
        if (user.getScore() >= 40){ // If the user reaches 40 scores or more, the algorithms os unlocked
            mergeSortStatusLabel.setIcon(new ImageIcon("src/main/java/CulminatingTask/Images/lock-open-variant.png"));
            mergeSortStatusLabel.setText("Unlocked");
        } else { // If the user didn't reach 25 scores or more, show the required score for unlock
            mergeSortStatusLabel.setIcon(new ImageIcon("src/main/java/CulminatingTask/Images/lock.png"));
        ...
        if (user.getScore() >= 55){ // If the user reaches 55 scores or more, the algorithms os unlocked
            radixSortStatusLabel.setIcon(new ImageIcon("src/main/java/CulminatingTask/Images/lock-open-variant.png"));
            radixSortStatusLabel.setText("Unlocked");
        } else { // If the user didn't reach 55 scores or more, show the required score for unlock
            radixSortStatusLabel.setIcon(new ImageIcon("src/main/java/CulminatingTask/Images/lock.png"));
        ...
        if (user.getScore() >= 75){ // If the user reaches 75 scores or more, the algorithms os unlocked
            gnomeSortStatusLabel.setIcon(new ImageIcon("src/main/java/CulminatingTask/Images/lock-open-variant.png"));
            gnomeSortStatusLabel.setText("Unlocked");
        } else { // If the user didn't reach 75 scores or more, show the required score for unlock
            gnomeSortStatusLabel.setIcon(new ImageIcon("src/main/java/CulminatingTask/Images/lock.png"));
        ...
        if (user.getScore() >= 100){ // If the user reaches 100 scores or more, the algorithms os unlocked
            quickSortStatusLabel.setIcon(new ImageIcon("src/main/java/CulminatingTask/Images/lock-open-variant.png"));
            quickSortStatusLabel.setText("Unlocked              ");
        } else { // If the user didn't reach 100 scores or more, show the required score for unlock
            quickSortStatusLabel.setIcon(new ImageIcon("src/main/java/CulminatingTask/Images/lock.png"));
        ...
        userPictureLabel.setIcon(new ImageIcon("src/main/java/CulminatingTask/Images/account-circle-2.png"));

        // Close button on top:
        closeButtonFromProfile.setBackground(new Color(255, 150, 102));
        closeButtonFromProfile.setIcon(new ImageIcon("src/main/java/CulminatingTask/Images/close-circle.png"));
        ...
        minButtonFromProfile.setIcon(new ImageIcon("src/main/java/CulminatingTask/Images/minus-circle.png"));
        ...
        returnToMenuFromProfile.setIcon(new ImageIcon("src/main/java/CulminatingTask/Images/home-circle.png"));
        ...
        infoButtonFromProfile.setIcon(new ImageIcon("src/main/java/CulminatingTask/Images/information.png"));
