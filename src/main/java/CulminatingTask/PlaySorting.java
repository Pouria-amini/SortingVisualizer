...
public class PlaySorting extends JPanel {
    ...
    private void initComponents() {
        ...
        closeButtonFromPS.setIcon(new ImageIcon("src/main/java/CulminatingTask/Images/close-circle.png"));
        ...
        minButtonFromPS.setIcon(new ImageIcon("src/main/java/CulminatingTask/Images/minus-circle.png"));
        ...
        returnHomeButtonFromPS.setIcon(new ImageIcon("src/main/java/CulminatingTask/Images/home-circle.png"));
        ...
        infoButtonFromPS.setIcon(new ImageIcon("src/main/java/CulminatingTask/Images/information.png"));
    ...
    public static void updateUserScore(int newScore) {
        try {
            ...
            File userInfoFile = new File("src/main/java/CulminatingTask/UserInfo.csv");
